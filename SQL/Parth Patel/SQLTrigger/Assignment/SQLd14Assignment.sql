...
VALUES(101,'RAKESH',25000,5000),(102,'MUKESH',20000,9000),
(103,'MAHESH',30000,10000),(104,'MANISH',38000,12000);
...
VALUES(11,'C',10000),(12,'C++',15000),
(13,'C#',20000),(14,'NodeJs',18000);
...
BEGIN
	UPDATE Student
	SET TotalFees = TotalFees + (SELECT TotalFees FROM Course
	WHERE Course.CourseID = CourseId)
	,RemainingAmt = RemainingAmt + (SELECT TotalFees FROM Course 
...
BEGIN
	...
	SET TotalFees = TotalFees + (
		SELECT SUM(c.TotalFees) FROM CourseEnrolled ce
